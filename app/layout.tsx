...
export const metadata: Metadata = {
  ...
  description: 'PhD researcher in Earth System Science with 7+ years of GIS and remote sensing expertise. Specializing in precision agriculture, geospatial analysis, and environmental mapping.',
  generator: 'v0.app',
  icons: {
    icon: [
      {
